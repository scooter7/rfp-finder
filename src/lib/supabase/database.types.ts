...
export type Database = {
  public: {
    Tables: {
      ...
      saved_rfps: { Row: { user_id: string; rfp_id: string; notes: string | null; created_at: string }; Insert: { user_id: string; rfp_id: string; notes?: string | null }; Update: Partial<{ notes: string | null }>; Relationships: [] };
      awards: {
        Row: {
          id: string;
          source_id: string;
